...
- 🔭 **Actuellement** : **Je Fais mon Stage dans le labo : LIRE ** dans le domaine de l'analyse de donnée plus Principalement les **Série Temporelles** en utilisant l'**Intelligence Artificielle**.
